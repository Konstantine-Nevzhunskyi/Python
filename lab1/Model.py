...
class Model:
    """ Class Model provides all operations on users list and books list in the library.

    Attributes:
        __users_list(list): List of all library users.
        __books_list(list): List of all library books.
    """
